...
abstract class sfModelGeneratorHelper
{
  ...
  {
    return '<li class="sf_admin_action_save"><button class="btn btn-success" type="submit" value="'.__($params['label'], array(), 'sf_admin').'" > <i class="bi bi-floppy"></i>'.__($params['label'], array(), 'sf_admin').'</button></li>';
  }
  ...
  public function linkToSaveAndAdd($object, $params)
  {
    ...
    return '<li class="sf_admin_action_save_and_add"><button class="btn btn-success"  type="submit" value="'.__($params['label'], array(), 'sf_admin').'" name="_save_and_add" ><i class="bi bi-floppy2-fill"></i>'.__($params['label'], array(), 'sf_admin').'</button></li>';
  }
}
